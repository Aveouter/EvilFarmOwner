...
4. Verify the named NPC enters from a genuine external farm entrance and both peers observe the same worker, target sequence, watering actions, and return.
